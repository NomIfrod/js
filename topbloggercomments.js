    ...
    var excludeMe = false;       // true: exclude my own comments
    var excludeUsers = ["Ifrod Maksum"];     // exclude these usernames
    var maxUserNameLength = 0; // 0: don't cut, >4: cut usernames
    //
